...
#define GPIO_GPO_ADDR       (GPIO_BASE + 0x000)
#define GPIO_GPI_ADDR       (GPIO_BASE + 0x004)
#define GPIO_SEG_ADDR       (GPIO_BASE + 0x008)

#define PS2_KEY_ADDR        (PS2_BASE + 0x000)
