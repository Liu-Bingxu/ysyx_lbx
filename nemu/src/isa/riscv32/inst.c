...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
    ...
    INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh, R, printf("now is %lld,%lld\n",(long long)src1,(long long)src2); (rd) = ((long long)((sword_t)src1 * (sword_t)src2) >> MUXDEF(CONFIG_ISA64, 64, 32)););
