...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
    ...
    INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh, R, printf("now is %llx\n",(long long)((sword_t)src1*(sword_t)src2)); (rd) = ((long long)((sword_t)src1 * (sword_t)src2) >> MUXDEF(CONFIG_ISA64, 64, 32)););
