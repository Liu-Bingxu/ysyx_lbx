...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
    ...
    INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh, R, long _src1 = (sword_t)src1; long _src2 = (sword_t)src2; printf("now is %ld,%ld,%lx\n", _src1, _src2, _src1*_src2); (rd) = ((long long)((sword_t)src1 * (sword_t)src2) >> MUXDEF(CONFIG_ISA64, 64, 32)););
